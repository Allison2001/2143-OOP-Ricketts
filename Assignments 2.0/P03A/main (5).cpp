...
map< string, string > Hands::Names = {
  ...
  /**
    ...
    void winner(Player p1, Player p2) {
            ...
            if (p1 > p2) {
                cout << "Player 1's " << p1.weapon1 << " beats Player 2's " << p2.weapon1 << endl;
            }
            else if (p2 > p1) {
                cout << "Player 1's " << p1.weapon1 << " is defeated by Player 2's " << p2.weapon1  << endl;
            }
            else {
                cout << "Player 1's" << p1.weapon1 << " Is the same as Player 2's throw, so it's a tie." << endl;
            }
